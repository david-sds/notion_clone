...
abstract class $SyncStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({EntityType entity, DateTime lastSyncedAt});
}
...
class _$SyncStateImpl implements _SyncState {
  const _$SyncStateImpl({required this.entity, required this.lastSyncedAt});
  ...
  @override
  String toString() {
    return 'SyncState(entity: $entity, lastSyncedAt: $lastSyncedAt)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, entity, lastSyncedAt);
